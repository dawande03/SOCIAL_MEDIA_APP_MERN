...
export const addPost =(values)=>async dispatch=>{
    ...
    try {
        await axios.post('http://localhost:8005/api/post/addpost' , values)
...
export const getAllPosts =()=>async dispatch=>{
    ...
    try {
        const response = await axios.get('http://localhost:8005/api/post/getallposts')
        dispatch({type:'LOADING' , payload:false})
...
export const likeOrUnlikePost =(values)=>async dispatch=>{
    ...
    try {
        await axios.post('http://localhost:8005/api/post/likeorunlikepost' , values)
...
export const addComment =(values)=>async dispatch=>{
    ...
    try {
        await axios.post('http://localhost:8005/api/post/addcomment' , values)
...
export const editPost =(values)=>async dispatch=>{
    ...
    try {
        await axios.post('http://localhost:8005/api/post/editpost' , values)
...
export const deletePost =(values)=>async dispatch=>{
    ...
    try {
        await axios.post('http://localhost:8005/api/post/deletepost' , values)
